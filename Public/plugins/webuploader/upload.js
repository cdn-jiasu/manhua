$(function() {
    ...
    function webuploader(opts) {
        ...
        uploader.on('uploadSuccess', function(file, data) {
            ...
            if (data.state == 'SUCCESS') {
                ...
                $('#' + file.id).append('<input type="hidden" class="bookimgs" value="' + data.url + '" >');
    ...
    window.Manager = {
        ...
        del: function(obj) {
            if (!confirm('确定删除吗?')) return false;
            $.get(
                "/admin/FileUpload/delupload", { action: "del", filename: $(obj).attr('data-img') },
                function() {
